		...
		evaluationChart( chart )
{
	...
	text_description = new wxTextCtrl(this, YE_TEXT_DESCRIPTION, wxEmptyString);
	label_group = new wxStaticText(this, wxID_ANY, _("Group"));
	const wxString *choice_group_choices = NULL;
	choice_group = new wxChoice(this, YE_CHOICE_GROUP, wxDefaultPosition, wxDefaultSize, 0, choice_group_choices, 0);
